...
var Block = React.createClass({
  ...
  formattedText() {
    var formatter = new BlockFormatter(this.rawText());
  ...
  handleHover(e) {
    ...
    this.timeout = setTimeout( () => {
      this.handleHoverLink(node, this.linkActive);
    }, 250);
  },
  ...
  render() {
    ...
    if (this.isEmpty()) {
      ...
      return React.createElement(type, attr, this.childBlocks());
    }
  }
});
