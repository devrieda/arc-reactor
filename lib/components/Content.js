...
var Content = React.createClass({
  ...
  componentDidUpdate() {
    var reselect = this.state.selection.reselect();
    var retype   = this.state.selection.retype();
    var recenter = this.state.selection.recenter();

    if (reselect || retype || recenter) { this.checkSelection(); }
  },
