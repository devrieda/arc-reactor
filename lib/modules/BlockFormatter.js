...
class BlockFormatter {
  ...
  applyMarkup(markups) {
    ...
    this._applyMarkup(this.node, markups.get('a'),      'a',      CLASS_NAMES.link);
    this._applyMarkup(this.node, markups.get('strong'), 'strong', CLASS_NAMES.bold);
    this._applyMarkup(this.node, markups.get('em'),     'em',     CLASS_NAMES.italic);

    return this.node.innerHTML;
  }

  _applyMarkup(node, markups, type, klass) {
