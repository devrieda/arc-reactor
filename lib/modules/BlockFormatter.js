...
class BlockFormatter {
  ...
  applyMarkup(markups) {
    ...
    this._applyMarkup(markups.get('a'),      'a',      CLASS_NAMES.link);
    this._applyMarkup(markups.get('strong'), 'strong', CLASS_NAMES.bold);
    this._applyMarkup(markups.get('em'),     'em',     CLASS_NAMES.italic);
